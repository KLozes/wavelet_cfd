#ifndef STGD_LOW_MACH_SOLVER_H
#define STGD_LOW_MACH_SOLVER_H

#include "MultiLevelSparseGrid.cuh"

class StgdLowMachSolver : public MultiLevelSparseGrid {
public:
  ...
  StgdLowMachSolver(real *domainSize_, i32 *baseGridSize_, i32 nLvls_) :
