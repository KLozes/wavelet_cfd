...
int main(int argc, char* argv[]) {
  ...
  i32 nBlocksX = (argc > 3) ? atoi(argv[3]) : (testCase == 1 ? 16 : (testCase == 2 ? 40 : (testCase == 3 ? 8 : (testCase == 4 ? 40 : 100))));
  ...
  bool square = (testCase == 1 || testCase == 2 || testCase == 4);
  ...
  real cfl  = 0.40;
  real tEnd  = (testCase == 2) ? 1.0 : (testCase == 3 ? 0.15 : (testCase == 4 ? 1.0 : 0.20));
  real tStep = (testCase == 1) ? 0.008 : (testCase == 2 ? 0.1 : (testCase == 3 ? 0.03 : (testCase == 4 ? 0.1 : 0.01)));
  ...
  solver->icType          = (testCase == 1) ? 1 : (testCase == 2 ? 2 : (testCase == 3 ? 3 : (testCase == 4 ? 4 : 0)));
